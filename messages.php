...
<div class="md:pl-64 pb-20 md:pb-0">
    ...
    <script>
        ...
        function formatTime(timestamp) {
            if (!timestamp) return '';
            return window.portalTime ? window.portalTime.format(timestamp, 'relative') : window.formatDate(timestamp, 'relative');
        }
        
        function formatDateTime(timestamp) {
            if (!timestamp) return '';
            return window.portalTime ? window.portalTime.format(timestamp, 'time') : window.formatDate(timestamp, 'time');
        }
